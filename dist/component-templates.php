...
function deeson_twig_component_templates($assetPath = 'auto') {
  return [ 
        ...
        "badge" => [
          "template" => "badge",
          "path" => $assetPath . "/components/fhrs/Badge",
          "variables" => ["content" => []]
        ], 
        "ratingsSearchBox" => [
          "template" => "ratingsSearchBox",
          "path" => $assetPath . "/components/fhrs/RatingsSearchBox",
          "variables" => ["content" => []]
        ], 
        "badgeDownload" => [
          "template" => "badgeDownload",
